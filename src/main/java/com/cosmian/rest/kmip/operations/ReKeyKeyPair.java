...
public class ReKeyKeyPair implements KmipStruct {
    ...
    /**
     * Determines the existing Asymmetric key pair to be re-keyed. If omitted, then
     * the ID Placeholder is substituted by the server.
     */
    @JsonProperty(value = "PrivateKeyUniqueIdentifier")
    private Optional<String> privateKeyUniqueIdentifier = Optional.empty();

    /**
     * An Interval object indicating the difference between the Initial Date and the
     * Activation Date of the replacement key pair to be created.
     */
    @JsonProperty(value = "Offset")
    private Optional<Integer> offset = Optional.empty();

    /**
     * Specifies desired attributes that apply to both the Private and Public Key
     * Objects.
     */
    ...
    /**
     * Specifies all Protection Storage Mask selections that are permissible for the
     * new Private Key and new Public Key objects
     */
    ...
    public String toString() {
        return "{" +
                ...
                ", offset='" + getOffset() + "'" +
                ", common_attributes='" + getCommon_attributes() + "'" +
                ", privateKeyAttributes='" + getPrivateKeyAttributes() + "'" +
                ", publicKeyAttributes='" + getPublicKeyAttributes() + "'" +
