...
build_native_library git@github.com:Cosmian abe_gpsw v2.0.2 libcosmian_abe_gpsw.so
build_native_library git@github.com:Cosmian cover_crypt v6.0.5 libcosmian_cover_crypt.so
build_native_library git@gitlab.cosmian.com:core findex v0.7.0 libcosmian_findex.so
