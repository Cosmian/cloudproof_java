...
public class TestAbe {
	...
	private static final Logger logger = Logger.getLogger(TestAbe.class.getName());
	...
	public void testObjectsSerDe() throws Exception {
		String private_key_json = Resources.load_resource("private_key.json");
		...
		String public_key_json = Resources.load_resource("public_key.json");
