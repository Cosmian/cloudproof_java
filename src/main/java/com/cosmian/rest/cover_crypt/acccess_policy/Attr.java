...
public class Attr extends AccessPolicy {
    ...
    public static VendorAttribute toVendorAttribute(Attr[] policyAttributes) throws CosmianException {
        ...
        try {
            ...
            throw new CosmianException("Failed serializing to JSON the CoverCrypt attributes: " + e.getMessage(), e);
        }
        return new VendorAttribute(VendorAttribute.VENDOR_ID_COSMIAN, VendorAttribute.VENDOR_ATTR_COVER_CRYPT_ATTR,
            value);
    }
}
