package com.cosmian.rest.cover_crypt;
...
import com.cosmian.rest.cover_crypt.data.DataToEncrypt;
...
/**
 * CoverCrypt (Attribute Based Encryption) endpoints
 */
public class CoverCrypt {
    ...
    public String[] createMasterKeyPair(Policy policy) throws CosmianException {
        try {
            Attributes commonAttributes =
                new Attributes(ObjectType.Private_Key, Optional.of(CryptographicAlgorithm.CoverCrypt));
            ...
            String err = "CoverCrypt: Master Key generation failed: " + e.getMessage() + "  " + e.getClass();
            logger.severe(err);
    ...
    public PrivateKey retrievePrivateMasterKey(String privateMasterKeyUniqueIdentifier) throws CosmianException {
        try {
            ...
            String err =
                "CoverCrypt: Private Master Key could not be retrieved: " + e.getMessage() + "  " + e.getClass();
            logger.severe(err);
            throw new CosmianException(err, e);
        }
    }
    ...
    public String importPrivateMasterKey(String uniqueIdentifier, PrivateKey privateMasterKey, boolean replaceExisting)
        ...
        try {
            ...
            String err =
                "CoverCrypt: Private Master Key could not be imported: " + e.getMessage() + "  " + e.getClass();
            logger.severe(err);
            throw new CosmianException(err, e);
        }
    }
    ...
    public PublicKey retrievePublicMasterKey(String publicMasterKeyUniqueIdentifier) throws CosmianException {
        try {
            ...
            String err =
                "CoverCrypt: Public Master Key could not be retrieved: " + e.getMessage() + "  " + e.getClass();
            logger.severe(err);
            throw new CosmianException(err, e);
        }
    }
    ...
    public String importPublicMasterKey(String uniqueIdentifier, PublicKey publicMasterKey, boolean replaceExisting)
        ...
        try {
            ...
            String err = "CoverCrypt: Public Master Key could not be imported: " + e.getMessage() + "  " + e.getClass();
            logger.severe(err);
            throw new CosmianException(err, e);
        }
    }
    ...
    public PrivateKey retrieveUserDecryptionKey(String userDecryptionKeyUniqueIdentifier) throws CosmianException {
        try {
            ...
            String err =
                "CoverCrypt: User Decryption Key could not be retrieved: " + e.getMessage() + "  " + e.getClass();
            logger.severe(err);
            throw new CosmianException(err, e);
        }
    }
    ...
    public String importUserDecryptionKey(String uniqueIdentifier, PrivateKey userDecryptionKey,
        ...
        try {
            ...
            String err =
                "CoverCrypt: User Decryption Key could not be imported: " + e.getMessage() + "  " + e.getClass();
            logger.severe(err);
            throw new CosmianException(err, e);
        }
    }
    ...
    public String revokeAttributes(String privateMasterKeyUniqueIdentifier, Attr[] policyAttributes)
        ...
        try {
            ...
            attributes.vendorAttributes(Optional.of(new VendorAttribute[] {Attr.toVendorAttribute(policyAttributes)}));
            ...
            String err = "Revocation of CoverCrypt policy attributes failed: " + e.getMessage() + "  " + e.getClass();
            logger.severe(err);
            throw new CosmianException(err, e);
        }
    }
