...
public enum CryptographicAlgorithm {
    ...
    DSA(0x0000_0005),
    ECDSA(0x0000_0006),
    HMAC_SHA1(0x0000_0007),
    HMAC_SHA224(0x0000_0008),
    HMAC_SHA256(0x0000_0009),
    HMAC_SHA384(0x0000_000A),
    HMAC_SHA512(0x0000_000B),
    HMAC_MD5(0x0000_000C),
    DH(0x0000_000D),
    ECMQV(0x0000_000F),
    ...
    Twofish(0x0000_0019),
    EC(0x0000_001A),
    One_Time_Pad(0x0000_001B),
    ChaCha20(0x0000_001C),
    Poly1305(0x0000_001D),
    ChaCha20Poly1305(0x0000_001E),
    SHA3_224(0x0000_001F),
    SHA3_256(0x0000_0020),
    SHA3_384(0x0000_0021),
    SHA3_512(0x0000_0022),
    HMAC_SHA3_224(0x0000_0023),
    HMAC_SHA3_256(0x0000_0024),
    HMAC_SHA3_384(0x0000_0025),
    HMAC_SHA3_512(0x0000_0026),
    SHAKE_128(0x0000_0027),
    SHAKE_256(0x0000_0028),
    ARIA(0x0000_0029),
    SEED(0x0000_002A),
    SM2(0x0000_002B),
    SM3(0x0000_002C),
    SM4(0x0000_002D),
    GOST_R_34_10_2012(0x0000_002E),
    GOST_R_34_11_2012(0x0000_002F),
    GOST_R_34_13_2015(0x0000_0030),
    GOST_28147_89(0x0000_0031),
    XMSS(0x0000_0032),
    SPHINCS_256(0x0000_0033),
    Page_166_of_230McEliece(0x0000_0034),
    McEliece_6960119(0x0000_0035),
    McEliece_8192128(0x0000_0036),
    Ed25519(0x0000_0037),
    Ed448(0x0000_0038),
    LWE(0x8880_0001),
    TFHE(0x8880_0002),
