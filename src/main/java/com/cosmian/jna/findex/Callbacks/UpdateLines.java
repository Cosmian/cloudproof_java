...
public class UpdateLines implements UpdateLinesCallback {
    ...
    public int apply(Pointer removedChainsPointer,
        ...
        List<Uid> removedChains = Leb128Reader.deserializeCollection(Uid.class, removedChainsBytes);
        ...
        Map<Uid, EntryTableValue> newEntries =
            Leb128Reader.deserializeMap(Uid.class, EntryTableValue.class, newEntriesBytes);
        ...
        Map<Uid, ChainTableValue> newChains =
            Leb128Reader.deserializeMap(Uid.class, ChainTableValue.class, newChainsBytes);
